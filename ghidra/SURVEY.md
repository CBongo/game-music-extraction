...
*Deliverable of bead `gib.1.1` (2026-07-03). Lives in GME's `ghidra/` directory while the
extension incubates here; this directory migrates to the extension's own repo at
repo-birth (see the migration note on epic `gib.1`).*
