...
python extract_akao.py ff7.yaml ~/psx/ff7/ff7us-disc1.bin --song 0x08
python extract_akao.py ff8.yaml ../psx/ff8/FF8_DISC1.BIN --song 0x1b
python extract_akao.py ff9.yaml ~/psx/ff9/ff9_disc1.bin --song 0x2e
python extract_akao.py chrono_cross.yaml ~/psx/cc/CHRONOCROSS1.BIN --song 0x18
